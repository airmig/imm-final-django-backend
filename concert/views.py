...
def songs(request):
    ...
    "lyrics":"Morbi non lectus. Aliquam sit amet diam in magna bibendum imperdiet. Nullam \
    orci pede, venenatis non, sodales sed, tincidunt eu, felis."}]}
    return render(request, "songs.html", {"songs":[{"id":1,"title":"duis faucibus accumsan odio curabitur convallis",\
    "lyrics":"Morbi non lectus. Aliquam sit amet diam in magna bibendum imperdiet. Nullam \
    orci pede, venenatis non, sodales sed, tincidunt eu, felis."}] })
